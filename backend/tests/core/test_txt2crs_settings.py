...
TXT2CRS_COMPOSITION_ENVIRONMENT_NAMES = (
    ...
    "TXT2CRS_WORKER_HEARTBEAT_SECONDS",
...
def test_txt2crs_composition_uses_conservative_p0_defaults() -> None:
    ...
    assert settings.TXT2CRS_WORKER_HEARTBEAT_SECONDS == 5
    ...
    assert settings.TXT2CRS_ADMISSION_MAXIMUM_JOBS_PER_USER == 4
    assert settings.TXT2CRS_ADMISSION_MAXIMUM_JOBS_GLOBAL == 10
    assert settings.TXT2CRS_ADMISSION_MAXIMUM_RESERVED_TOKENS_PER_USER == 3_000_000
    assert settings.TXT2CRS_ADMISSION_MAXIMUM_RESERVED_TOKENS_GLOBAL == 7_500_000
    assert settings.TXT2CRS_ADMISSION_MAXIMUM_RESEARCH_MICROUSD_PER_USER == 4_000_000
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("TXT2CRS_WORKER_HEARTBEAT_SECONDS", 0),
