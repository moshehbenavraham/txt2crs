...
**Intended release**:
<https://github.com/moshehbenavraham/txt2crs/tree/v1.0.0>
...
3. the final commit that the human operator will tag as `v1.0.0`.
...
3. creates annotated tag `v1.0.0` on that exact commit;
...
Any tracked change after `v1.0.0` requires a new SemVer release rather than
moving the tag.
