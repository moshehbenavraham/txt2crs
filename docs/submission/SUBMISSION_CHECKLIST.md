...
- [x] The authenticated create, progress, results, preview, and answer-key
  journey is implemented.
- [x] Deterministic end-to-end evidence is recorded for `1.0.0`.
- [x] The historical live `gpt-5.6-sol` plus Tavily proof remains tied to
  revision `a80700863e99cdd34bed757873d969236cdf36fa`.
- [x] All sixteen live artifact pairs have recorded human inspection results.
- [x] The repository explains its local-only and synthetic-data boundaries.

## Submission Assets

- [x] The root README tells the product story and links the reproducible sample.
- [x] Six synthetic screenshots are reviewed and indexed with dimensions and
  SHA-256 values.
- [x] The Codex feedback Session ID is recorded.
- [x] The narrated video candidate is 02:22.600 and privacy-reviewed.
...
2. review the final local commit, then create and push `v1.0.0`;
