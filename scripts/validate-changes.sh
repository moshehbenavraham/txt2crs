...
if [ "$OUTPUT_JSON" = true ]; then
    ...
    if [ "$RUN_BACKEND" = true ]; then
        run_json_check "backend-lint" \
            "uv run ruff check app tests/core/test_logging.py tests/core/test_txt2crs_settings.py tests/scripts/test_container_contract.py tests/scripts/test_generate_client_contract.py tests/scripts/test_quality_workflow_contract.py tests/scripts/test_security_workflow_contract.py" \
            "$PROJECT_ROOT/backend"
        run_json_check "backend-format" \
            "uv run ruff format --check app tests/core/test_logging.py tests/core/test_txt2crs_settings.py tests/scripts/test_container_contract.py tests/scripts/test_generate_client_contract.py tests/scripts/test_quality_workflow_contract.py tests/scripts/test_security_workflow_contract.py" \
            "$PROJECT_ROOT/backend"
